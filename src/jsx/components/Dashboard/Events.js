              ...
              <div className='card event-bx'>
                  ...
                  <div className='overlay-bx row p-3 p-xl-5 '>
                    <div className='col-lg-6 p-0'>
                      <h2 className='text-white mb-4'>
                        Beautiful Fireworks Show In The New Year Night 2020.
                      </h2>
                      <Link className='btn btn-primary rounded' to='/events'>
                        <svg
                          className='mr-3'
                          width={16}
                          height={16}
                ...
                <div className='card-body'>
                  <div className='row align-items-center'>
                    <div className='col-xl-8 col-xxl-12 event-des-content'>
                      <div className='border-right'>
                        <h3 className='text-black'>Event Description</h3>
                        <p>
                    ...
                    <div className='col-xl-4 col-xxl-12'>
                      <div className='media mb-4 align-items-center'>
                        ...
                        <div className='media-body'>
                          ...
                          <h4 className='mb-0 text-black'>$124,00</h4>
                        </div>
                      </div>
                      <div className='media mb-4 align-items-center'>
                        <div className='mr-3'>
              ...
              <div className='card bg-transparent shadow-none'>
                ...
                <div className='card-body p-0 bg-white rounded shadow'>
                  <div className='table-responsive'>
                    <table className='table fs-14 table-responsive-md'>
                      <thead>
                        <tr>
                          <th>Order ID</th>
                          <th>Date</th>
